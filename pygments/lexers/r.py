...
from pygments.lexer import Lexer, RegexLexer, bygroups, do_insertions, include
...
class SLexer(RegexLexer):
    ...
    tokens = {
        ...
        "namespace": [
            (rf"({valid_name})(::|:::)(?=\w)", bygroups(Name.Namespace, Operator)),
        ],
        "function_name": [
        ...
        "statements": [
            ...
            include("keywords"),
            include("namespace"),  # Include namespace rule
